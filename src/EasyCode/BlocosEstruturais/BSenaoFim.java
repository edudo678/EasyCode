 ...
 * @author Endy Takano
 */
public class BSenaoFim extends Bloco {
    private final Dimension dimensoes = new Dimension(102,20);
    /**
     * Creates new form BSeFim
     */
    public BSenaoFim() {
        super("FimSenao","Estrutura Fim Se");
        initComponents();
        setSize(dimensoes);
    }
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(79, 137, 255));
