 ...
 * @author Endy Takano
 */
public class BEscolhaCasoFim extends Bloco {
    /**
     * Creates new form BEscolhaCase
     */
    private final Dimension dimensoes = new Dimension(92,21);
    public BEscolhaCasoFim() {
        super("FimCaso","Estrutura Fim Caso");
        initComponents();
        setSize(dimensoes);
    }
 public Dimension getDimensoes() {
    ...
    private void initComponents() {
        ...
        bEnquantoFim1 = new EasyCode.BlocosEstruturais.BEnquantoFim();
 ...
 @Override
    ...
    private EasyCode.BlocosEstruturais.BEnquantoFim bEnquantoFim1;
