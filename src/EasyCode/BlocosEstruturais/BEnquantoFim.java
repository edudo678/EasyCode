 ...
 * @author Endy Takano
 */
public class BEnquantoFim extends Bloco {
    private final Dimension dimensoes = new Dimension(126,20);
    /**
     * Creates new form BEnquantoFIm
     */
    public BEnquantoFim() {
        super("FimEnquanto","Estrutura Fim Enquanto");
        initComponents();
        setSize(dimensoes);
    }
