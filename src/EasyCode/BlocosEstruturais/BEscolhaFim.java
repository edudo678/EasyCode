 ...
 * @author Endy Takano
 */
public class BEscolhaFim extends Bloco {
    private final Dimension dimensoes = new Dimension(119,20);
    /**
     * Creates new form BEscolhaFim
     */
    public BEscolhaFim() {
        super("FimEscolha","Estrutura Fim Escolha");
        initComponents();
        setSize(dimensoes);
    }
