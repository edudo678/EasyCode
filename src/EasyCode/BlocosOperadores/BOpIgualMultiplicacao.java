 ...
 * @author CCE
 */
public class BOpIgualMultiplicacao extends Bloco {

     private final Dimension dimensoes = new Dimension(282,24);
    /**
     * Creates new form BOpSoma
     */
    public BOpIgualMultiplicacao() {
        super("IgualMultiplicacao","Operador Igual Multiplicacao");
        initComponents();
        setSize(dimensoes);
    }
    public BOpIgualMultiplicacao(String condicao1,String condicao2) {
        super("IgualMultiplicacao","Operador Igual Multiplicacao");
        initComponents();
