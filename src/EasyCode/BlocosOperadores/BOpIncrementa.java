 ...
 * @author CCE
 */
public class BOpIncrementa extends Bloco {
 private final Dimension dimensoes = new Dimension(155,24);
    /**
     * Creates new form BOpSoma
     */
    public BOpIncrementa() {
        super("Incrementa","Operador Incrementa");
        initComponents();
        setSize(dimensoes);
    }
    public BOpIncrementa(String condicao) {
        super("Incrementa","Operador Incrementa");
        initComponents();
        setSize(dimensoes);
        N1.setText(condicao);
