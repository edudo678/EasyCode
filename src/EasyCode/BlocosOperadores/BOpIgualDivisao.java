 ...
 * @author CCE
 */
public class BOpIgualDivisao extends Bloco {

    private final Dimension dimensoes = new Dimension(281,24);
    /**
     * Creates new form BOpSoma
     */
    public BOpIgualDivisao() {
        super("IgualDivisao","Operador Igual Divisao");
        initComponents();
        setSize(dimensoes);
    }
    public BOpIgualDivisao(String condicao1, String condicao2) {
        super("IgualDivisao","Operador Igual Divisao");
        initComponents();
